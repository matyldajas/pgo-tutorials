...
public class Main {
    public static void main(String[] args) {
        ...
        Employee e=new Employee("Marcin","Gad","Warszawa","67126713","gad@gmail.com",2009);
// Creating and adding developers
        Developer dev = new Developer("Jack","Kowalski","Warszawa","72626723","jack@gmail.com",2002);
        Technology t=new Technology("Java",800);
        Technology t1=new Technology("SQL",900);
        dev.addTechnology(t);
        dev.addTechnology(t1);
        employees.add(dev);
